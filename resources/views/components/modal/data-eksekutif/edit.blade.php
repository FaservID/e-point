<div id="editDataEksekutif" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="editDataEksekutif" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="POST" novalidate id="editDataEksekutifForm">
                @csrf
                @method('PUT')
